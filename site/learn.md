...
.learn .sub{color:#666;margin:0 0 20px}
.learn .part{margin:34px 0 4px;font-size:24px;color:#5a3d1a;border-top:3px solid #c9b98f;padding-top:18px}
.learn .panel{background:#fff;border:1px solid #d8cfb5;border-radius:8px;padding:16px 20px;margin:0 0 22px}
.learn .panel h2{margin:0 0 12px;font-size:18px;color:#5a3d1a}
.learn .row{display:flex;gap:20px;align-items:flex-start}
.learn .map{flex:0 0 auto}
.learn .note{flex:1;font-size:14px;line-height:1.45}
.learn .note p{margin:0 0 10px}
.learn .note ol{margin:0 0 10px 18px;padding:0}
.learn .note li{margin:0 0 6px}
.learn .cols{display:flex;gap:14px;align-items:stretch}
.learn .cols .calc{flex:1;margin-top:0}
...
.learn .calc{margin-top:14px;background:#f7f1de;border:1px solid #d8cfb5;border-radius:6px;padding:10px 14px;font-size:13px}
.learn .calc h3{margin:0 0 8px;font-size:15px}
.learn table{border-collapse:collapse;width:100%}
.learn th, .learn td{text-align:left;vertical-align:top;padding:4px 8px;border-bottom:1px solid #e3dac1}
.learn th{white-space:nowrap;color:#5a3d1a;font-weight:600}
.learn .ledger th{border-bottom:2px solid #c9b98f}
.learn .bad{color:#b00;font-weight:bold}
.learn .warn{color:#b8600b;font-weight:bold}
.learn .fine{color:#666;font-size:12px;margin:8px 0 0}
.learn .legend{display:flex;gap:18px;font-size:13px;color:#444;margin:0 0 18px;flex-wrap:wrap}
.learn .sw{display:inline-block;width:22px;height:14px;vertical-align:middle;border:1px solid #222;margin-right:5px;border-radius:2px}
</style>
